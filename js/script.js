...
M.toast({html: '<span class="red-text text-darken-1">The Form has been submitted succesfully!</span>'});
} else {
M.toast({html: '<span class="green-text text-accent-3">Fill in all Forms correctly!</span>'});
} 
});